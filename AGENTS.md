...
| [Chapter 13: Client Integration](.manual/chapter-13-client-integration.md)             | OpenCode install + agent bundles in `.agents/` (default + rote), make targets, model config and swapping models, OpenWebUI, Python SDK, curl, LangChain |
| [Chapter 14: Observability](.manual/chapter-14-observability.md)                       | Debug server, Prometheus metrics, pprof profiling, tracing                                                                                   |
| [Chapter 15: MCP Service](.manual/chapter-15-mcp-service.md)                           | Brave Search, MCP configuration, OpenCode client setup, curl testing                                                                         |
